        ...
        > extends AbstractCrudService<Entity, DTO, Repository, Mapper>
{
    ...
    public void deleteFileById(long id, long annexeId) {
        Annexe m = storageService.getById(annexeId);
    ...
    public void addAnnexe(long id, MultipartFile file) throws NullPointerException, FileStorageException {
